...
public class Main {
                                ...
                                vendas.stream().forEach(venda -> {
                                    if (venda.getEmpresa().getId().equals(usuarioLogado.getEmpresa().getId())) {
                                        ...
                                        if (usuarioLogado.IsEmpresa() || usuarioLogado.IsAdmin()) {
                                            ...
                                            // Somente as empresas irão ver essa informação
                                            if (usuarioLogado.IsEmpresa()) {
                        ...
                        switch (escolha) {
                            ...
                            case 1:
                                ...
                                Cliente clienteLogado = clientes.stream()
                                        ...
                                        .collect(Collectors.toList()).get(0);
                                Venda venda1 = criarVenda(carrinho, empresaEscolhida, clienteLogado, vendas);
                                System.out.println("Total: R$" + venda1.getValor());
                                System.out.println("************************************************************");
                                carrinho.clear();
    ...
    public static Venda criarVenda(List<Produto> carrinho, Empresa empresa, Cliente cliente, List<Venda> vendas) {
        ...
        // Adiconando um Double para o total descontando a taxa
